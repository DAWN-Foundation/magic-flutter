      ...
      body: Center(
        ...
        ElevatedButton(
          onPressed: () async {
            ...
            Ed25519HDPublicKey solanaWallet =
                Ed25519HDPublicKey.fromBase58(info.publicAddress!);
            ...
            // recentBlockhash
            var recentBlockhash = await client.getLatestBlockhash();
        ...
        ElevatedButton(
          onPressed: () async {
            ...
            // recentBlockhash
            var recentBlockhashWithCommitment =
            ...
            final signature = await client.sendTransaction(tx.encode());
